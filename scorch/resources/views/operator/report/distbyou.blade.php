...
<div class="item pt-5">
    <h2 class="text-lg font-medium">Resumen de Operaciones Registradas</h2>
    <p class="text-sm">Las siguientes son las operaciones registradas durante el periodo de tiempo entre las fechas dado.</p>
    @foreach ($operations->sortBy('opeDate') as $o)
...
<div class="item pt-5 pb-5">
    <h2 class="text-lg font-medium">Resumen de Distribución</h2>
    <p class="text-sm">El siguiente cuadro muestra un resumen de las cantidad de equipos entregados hasta la fecha dada según las operaciones registradas.</p>
    <div class="flex justify-center text-xs">
        <div class="item w-1/2 mt-2 border rounded p-4">
            ...
            <tbody class="text-xs">
                <tr class="text-gray-800 pt-5 ">
                    ...
                    @if ($parentOU->id == $childLvl2['ouID'])
                    <td class="text-sm font-medium">{{$childLvl2['ouName']}}</td>
                    <td class="text-sm font-medium text-center">{{$childLvl2['ouQuantity']}}</td>
                    @endif

                    @if ($parentOU->id == $childLvl2['ouMasterOU'])
                        <tr class="border-b border-indigo-100">
                            <td class="font-medium pl-2">{{$childLvl2['ouName']}}</td>
                            <td class="font-medium text-center">{{$childLvl2['ouQuantity']}}</td>
                        </tr>
                        @foreach ($ouChilds as $childLvl3)
                        @if ($childLvl2['ouID'] == $childLvl3['ouMasterOU'])
                        <tr>
                            <td class="pl-5">{{$childLvl3['ouName']}}</td>
                            <td class="text-center">{{$childLvl3['ouQuantity']}}</td>
                        </tr>
                        @endif
                        @endforeach
                    @endif
